...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center capitalize justify-between whitespace-nowrap border border-neutral-200 dark:border-neutral-700 rounded-lg bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:!text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-neutral-200 dark:disabled:bg-neutral-700 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
