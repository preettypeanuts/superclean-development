  ...
  return (
    <div data-tip="Theme" className="flex flex-col gap-2 w-full tooltip tooltip-right">
      ...
      <div className={`${!isExpanded && "hidden"} flex items-center gap-1 p-1 bg-neutral-100/40 dark:bg-neutral-500/20 rounded-lg relative overflow-hidden`}>
        ...
        <div
          className={`absolute z-10 h-6 w-[calc(50%-0.5rem)] bg-mainColor/50 rounded-md transition-transform duration-300 ${currentTheme === 'dark' ? 'translate-x-[calc(100%+0.25rem)]' : ''}`}
        />
      </div>
