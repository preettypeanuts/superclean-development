                            ...
                            <div className="grid grid-cols-2 gap-20 mt-5">
                                ...
                                <div className="col-span-1 space-y-4">
                                    ...
                                    <div className="flex items-center justify-between mt-5 px-3 py-2 bg-neutral-200 dark:bg-darkColor rounded-lg">
                                        ...
                                        <Label className="text-right font-bold text-2xl">{formatRupiah(transaction.finalPrice - manualDiscount)}</Label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <RupiahInput
                                placeholder="Rp. 0"
                                value={formatRupiah(
                                    (Number(formDataTable.harga) || 0) * (Number(formDataTable.jumlah) || 1) - (Number(formDataTable.promo) || 0)
                                )}
