...
export default function NewSPK() {
    ...
    return (
        <Wrapper className="relative">
            <div className="absolute inset-0 w-full h-full bg-black/30 flex items-center justify-center backdrop-blur-[2px] z-10"> Unfinished </div>
            <Header label="Tambah Pembayaran Baru" />
